...
// Extraire la puissance consommée en utilisant la nouvelle structure JSON
float consumedPower = doc2["Body"]["Data"]["Site"]["P_Load"];  // Récupérer la puissance consommée

Serial.print("Consommation extraite: ");
Serial.println(consumedPower);

// Assurez-vous que la valeur soit positive et un entier
gDisplayValues.watt = abs((int)consumedPower);  // Convertir en entier et prendre la valeur absolue
Serial.print("gDisplayValues.watt après traitement: ");
